  ...
  return (
    <main className="overflow-hidden">
      ...
      <div className='mt-12 padding-x padding-y max-width ' id="discover">
        ...
        <div className='home__filters'>
          <SearchBar setManufacturer={setManufacturer} setModel={setModel}></SearchBar>
    ...
    {allCars.length > 0  ? (
      <section>
        ...
        <ShowMore pageNumber={limit/10 } isNext={limit> allCars.length} setLimit={setLimit}></ShowMore>
      </section>
    ):(
